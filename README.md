...
- For **measurement** section, we first specify the number of measurements:
...
- For **diabetes** section, we further split into 2 subsections, <ins>DRP</ins> and <ins>DFS</ins>. Firstly, we specify the number of DRP sections: <img width="122" alt="image" src="https://github.com/user-attachments/assets/972596fd-b930-4c16-ad81-e630927cd88c" />
  ...
  - Next, we specify the number of DFS sections: <img width="127" alt="image" src="https://github.com/user-attachments/assets/0e39b809-0c27-4568-8994-64600185444c" />
...
7. In the **Screenings** sheet, ensure that the following fields are present:
